...
static CGPoint BezierWithPoints(NSUInteger degree, CGPoint *bezierPoints, CGFloat parameter)
{
...
static CGPoint Bezier(NSUInteger degree, NSBezierPath *bezier, CGFloat parameter)
{
    ...
    CGPoint bezierPoints[4] = {element1.point, element2.controlPoints[0], element2.controlPoints[1], element2.point};
    
    return BezierWithPoints(degree, bezierPoints, parameter);
}

static CGFloat NewtonsMethod(NSBezierPath *bezier, CGPoint point, CGFloat parameter)
{
...
- (NSBezierPath *) fb_fitCubicToRange:(NSRange)range leftTangent:(CGPoint)leftTangent rightTangent:(CGPoint)rightTangent errorThreshold:(CGFloat)errorThreshold;
...
- (NSBezierPath *) fb_fitBezierUsingNaiveMethodInRange:(NSRange)range leftTangent:(CGPoint)leftTangent rightTangent:(CGPoint)rightTangent;
...
- (NSBezierPath *) fb_fitBezierInRange:(NSRange)range withParameters:(NSArray *)parameters leftTangent:(CGPoint)leftTangent rightTangent:(CGPoint)rightTangent;
...
- (NSBezierPath *) fb_fitCurve:(CGFloat)errorThreshold
{
    ...
    CGPoint rightTangentVector = [self fb_computeRightTangentAtIndex:[self elementCount] - 1];
...
- (NSBezierPath *) fb_fitBezierInRange:(NSRange)range withParameters:(NSArray *)parameters leftTangent:(CGPoint)leftTangent rightTangent:(CGPoint)rightTangent
{
    ...
    CGPoint *a1 = (CGPoint *)calloc(range.length, sizeof(CGPoint));
    CGPoint *a2 = (CGPoint *)calloc(range.length, sizeof(CGPoint));    
    for (NSUInteger i = 0; i < range.length; i++) {
